...
from src.transformers.testing_utils import CaptureLogger
from src.transformers.trainer_utils import get_last_checkpoint
from src.transformers.utils import check_min_version, send_example_telemetry
...
class ModelArguments:
    ...
    tensor_backend: bool = field(default=False)
    ...
    with training_args.main_process_first(desc="dataset map tokenization"):
        if not data_args.streaming:
            ...
            tokenized_datasets.save_to_disk(
                os.path.join(os.getenv("HF_HOME"), "/datasets/c4/tokenized")
            )
